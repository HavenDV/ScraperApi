...
var api = new ScraperApiClient("bc07b32853472e8276803c731972fd5f", client);
...
using var client = ScraperApiClient.GetProxyHttpClient("bc07b32853472e8276803c731972fd5f");
